        ...
        <section className="worklog" aria-labelledby="worklog-title">
          ...
          <section className="worklog-section">
            ...
            <ul className="improvement-list">
              <li>Авторизация пользователей</li><li>PostgreSQL для масштабирования</li>
              <li>WebSocket/SSE для realtime-событий</li><li>Детальная история изменений</li>
              <li>Полноценное подтверждение опасных действий</li><li>Расширенное управление существами</li>
              <li>Frontend automated tests</li><li>Мониторинг и structured logging</li>
              <li>Детальная модель времени и аварийных состояний</li>
            </ul>
          </section>
        </section>
      )}
